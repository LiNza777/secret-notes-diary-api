...
async def create_note(db: AsyncSession, note_data: NoteCreateSchema, owner_id: int) -> Note:
...
async def update_note(db: AsyncSession, db_note: Note, note_data: NoteUpdateSchema) -> Note:
